        ...
        <>
         <div className="content-wrapper p-2">
            <div className="container-fluid shadow p-2 bg-white" style={{minHeight:"88vh"}}>
                    <h4 className="p-2 mb-3 border-bottom border-success">Stocks Buy Detail</h4>
                    ...
                    <div className="card shadow">
                        ...
                        <form>
                            ...
                            <>
                        <h4 className="text-success text-center p-2">Order confirmed</h4>
                        <div className="form-row">                        
                            <div className="col-sm-8 p-3">
                            <h5>Stock ID : {data?.bike?.id}</h5>                            
                            </div>
                        </div>
