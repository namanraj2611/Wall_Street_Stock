  ...
  <div className="carousel-inner">
    <div className="carousel-item active">
      ...
      <div className="carousel-caption d-none d-md-block">
        <h5>Find your Stock today!</h5>
        <h4>Book the best Stock for you</h4>
      </div>
    </div>
    <div className="carousel-item">
      ...
      <div className="carousel-caption d-none d-md-block">
        ...
        <h4>A lot of Stock available</h4>
      </div>
    </div>
    <div className="carousel-item">
        ...
        <div className="col-md-4">
          <div className="product-item">
            ...
            <div className="down-content">
              ...
              <h6><small>from</small> Rs120 <small>per Stocks</small></h6>
        ...
        <div className="col-md-4">
          <div className="product-item">
            ...
            <div className="down-content">
              ...
              <h6><small>from</small> Rs150 <small>per Stocks</small></h6>
              <h4>Lorem ipsume dolor sit amet, adipisicing elite. Itaque, corporis nulla aspernatur.</h4>
            </div>
          </div>
        </div>
