...
import com.cts.portfolioservice.daos.BookingRepository;
import com.cts.portfolioservice.daos.FeedbackRepository;
import com.cts.portfolioservice.daos.PaymentRepository;
...
public class BookingService {
	...
	@Autowired private StockService bksrv;
	...
	public void updateBooking(BookingStatusDTO dto) {
		...
		Stock bik=bksrv.findById(dto.getBno());
		bk.setBike(bik);
	...
	public void completeBooking(BookingCompleteDTO dto) {
		...
		Stock stock=bk.getBike();
		stock.setStatus("Available");
		bksrv.updateBike(stock);		
